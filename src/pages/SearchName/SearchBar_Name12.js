...
const SearchBarName12 = ({ setListData }) => {
        ...
        <div className="searchbar_out">
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
                <button className="searchButton1" onClick={() => {
                    axios.post('https://api-nelson.onrender.com/students/temp12', { "name": value, "Address": value1, "Common": value2 })
                        .then((response) => {
...
export default SearchBarName12;
