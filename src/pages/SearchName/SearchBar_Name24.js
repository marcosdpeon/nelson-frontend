...
const SearchBarName24 = ({ setListData }) => {
        ...
        <div className="searchbar_out">
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
                <button className="searchButton1" onClick={() => {
                    axios.post('https://api-nelson.onrender.com/students/temp24', { "name": value, "Common": value1, "Salud": value2 })
                        .then((response) => {
...
export default SearchBarName24;
