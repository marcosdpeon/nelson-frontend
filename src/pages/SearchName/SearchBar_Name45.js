...
const SearchBarName45 = ({ setListData }) => {
        ...
        <div className="searchbar_out">
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
                <button className="searchButton1" onClick={() => {
                    axios.post('https://api-nelson.onrender.com/students/temp45', { "name": value, "Salud": value1, "Fec_Nac": value2 })
                        .then((response) => {
...
export default SearchBarName45;
