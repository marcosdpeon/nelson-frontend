...
const SearchBarName34 = ({ setListData }) => {
        ...
        <div className="searchbar_out">
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "30px" }}>
                <button className="searchButton1" onClick={() => {
                    axios.post('https://api-nelson.onrender.com/students/temp34', { "name": value, "Regeion": value1, "Salud": value2 })
                        .then((response) => {
...
export default SearchBarName34;
