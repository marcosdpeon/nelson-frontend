...
const SearchBarRUTRegeion = ({ setListData }) => {
        ...
        <div className="searchbar_out">
            <div className="row">
                ...
                <div className="col-6 position-relative" style={{ paddingLeft: "5px" }}>
                    <input type="text" placeholder="Región" alt="search" className="input_name" value={value1} onChange={(e) => { setValue1(e.target.value) }} />
                </div>
            </div>
